...
;
alter table contribution add constraint fk_contribution_contributionType_1 foreign key (contribution_type_id) references contribution_type (id) on delete restrict on update restrict;
create index ix_contribution_contributionType_1 on contribution (contribution_type_id);



alter table contribution_contributor add constraint fk_contribution_contributor_contribution_01 foreign key (contribution_id) references contribution (id) on delete restrict on update restrict;

alter table contribution_contributor add constraint fk_contribution_contributor_contributor_02 foreign key (contributor_id) references contributor (id) on delete restrict on update restrict;
...
drop table contribution_contributor;
